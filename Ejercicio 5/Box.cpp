...
Box::Box(b2World& world, float x, float y) {
    ...
    bodyDef.position.Set(x / SCALE - 3, y / SCALE + 4);
    ...
    fixtureDef.density = 0.7; //Cambiamos aquí el peso de la caja
    fixtureDef.friction = 0.0f;  //Podemos probar los distintos coeficientes de rozamiento, aquí debajo dejo unos ejemplos
